...
const copy = {
  zh: {
    ...
    cartTitle: "查看购物袋",
    shippingGap: (amount) => `距离 KL 免费配送还差 <b id="shippingGap">${amount}</b>`,
    shippingDone: "已获得 KL 免费私密配送",
    emptyCart: "你的购物袋还是空的。",
    ...
    subtotal: "小计",
    discount: "通讯下单 9 折价",
    confirmation: "请帮我确认库存、配送与最终金额。",
    imageAlt: (name) => `${name} 商品图`,
    productShort: (category) => `${category} · 私密包装 · KL 配送`,
    category: {
      "网袜内裤": "网袜内裤",
      "网衣": "网衣",
      "99系列": "99系列",
  ...
  en: {
    ...
    shippingGap: (amount) => `${amount} away from free discreet KL delivery`,
    shippingDone: "Free discreet KL delivery unlocked",
    ...
    confirmation: "Please confirm stock, delivery and the final total for me.",
    imageAlt: (name) => `${name} product image`,
    productShort: (category) => `${category} · Discreet packaging · KL delivery`,
    category: {
  ...
  ms: {
    ...
    shippingGap: (amount) => `${amount} lagi untuk penghantaran sulit KL percuma`,
    shippingDone: "Penghantaran sulit KL percuma telah diperoleh",
    ...
    confirmation: "Sila sahkan stok, penghantaran dan jumlah akhir untuk saya.",
    imageAlt: (name) => `Imej produk ${name}`,
    productShort: (category) => `${category} · Pembungkusan sulit · Penghantaran KL`,
    category: {
...
const staticText = {
  "KL 全区满 RM180 享免费私密配送": { en: "Free discreet delivery across KL for orders over RM180", ms: "Penghantaran sulit percuma seluruh KL untuk pesanan melebihi RM180" },
  ...
  "48 小时": { en: "48 hours", ms: "48 jam" },
  "KL 市区极速送达": { en: "Fast city delivery", ms: "Penghantaran pantas dalam bandar KL" },
  "无标识私密包装": { en: "Unmarked discreet packaging", ms: "Pembungkusan sulit tanpa label" },
  ...
  "外箱不显示商品名称或品牌，以普通寄件资料寄出。": { en: "No product name or brand appears on the outer box; it is sent with ordinary sender details.", ms: "Nama produk atau jenama tidak tertera pada kotak luar; ia dihantar dengan butiran pengirim biasa." },
  ...
  "吉隆坡配送": { en: "Kuala Lumpur delivery", ms: "Penghantaran Kuala Lumpur" },
  "支持 KL 市区派送与到店自取；全程进度可查询。": { en: "KL city delivery and collection are available, with trackable order progress.", ms: "Penghantaran dalam bandar KL dan ambil sendiri tersedia, dengan kemajuan pesanan boleh dijejaki." },
  ...
  "距离 KL 免费配送还差": { en: "away from free discreet KL delivery", ms: "lagi untuk penghantaran sulit KL percuma" },
  ...
  "无标识包装 · 客服确认库存与配送 · KL 本地配送": { en: "Unmarked packaging · Stock and delivery confirmed by our team · KL local delivery", ms: "Pembungkusan tanpa label · Stok dan penghantaran disahkan oleh pasukan kami · Penghantaran tempatan KL" },
